...
export class UserSupportComponent {
  ...
  constructor(
    private formBuilder: FormBuilder, private supportservice: SupportService,
  ...
  saveSupport(){
    let user = {
      ...
      "issue": this.registerForm.controls['select'].value,
     "description":this.registerForm.controls['textArea'].value
      }

    console.log(user)
    this.supportservice.saveSupport(user).subscribe((res:any) => {
